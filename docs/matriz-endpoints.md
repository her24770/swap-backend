...
| EP-002 | POST | `/acuerdo/:id` | usuario | `createAgreement` | `mensajeria-coordinacion-real.test.ts`, `mensajeria-coordinacion.test.ts`, `autorizacion-endpoints.test.ts` |
...
| EP-017 | GET | `/auth/me` | usuario | `getCurrentSession` | `auth-sesion.test.ts`, `autorizacion-endpoints.test.ts` |
...
| EP-027 | POST | `/conversacion` | usuario | `startConversation` | `mensajeria-coordinacion-real.test.ts`, `mensajeria-coordinacion.test.ts`, `autorizacion-endpoints.test.ts` |
