...
- Rutas con al menos una invocación HTTP localizada: **99/100**
...
| EP-010 | DELETE | `/anuncio/:id_anuncio` | usuario | usuario | propietario del recurso | ✅ | `deleteAd` | `transversal-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-011 | PATCH | `/anuncio/:id_anuncio` | usuario | usuario | propietario del recurso | ✅ | `updateAd` | `transversal-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
...
| EP-015 | POST | `/auth/login` | público | público | no aplica | ✅ | `login` | `autenticacion-perfiles.test.ts`, `auth-sesion.test.ts`, `transversal-seguridad-real.test.ts` |
...
| EP-033 | GET | `/etiqueta` | público | público | no aplica | ✅ | `listTags` | `transversal-seguridad-real.test.ts` |
...
| EP-074 | PATCH | `/publicacion/:id/estado` | usuario | usuario | propietario del recurso | ✅ | `updatePublicationState` | `moderacion-seguridad-real.test.ts`, `perfil-publicaciones-resenas-real.test.ts`, `transversal-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-075 | POST | `/publicacion/buscar` | autenticado | autenticado | no aplica | ✅ | `searchPublications` | `perfil-publicaciones-resenas-real.test.ts`, `autorizacion-endpoints.test.ts` |
...
| EP-077 | GET | `/publicacion/user/:id` | autenticado | autenticado | no aplica | ✅ | `getUserPublications` | `perfil-publicaciones-resenas-real.test.ts`, `autorizacion-endpoints.test.ts` |
...
| EP-091 | POST | `/resenas` | usuario | usuario | sesión propia | ✅ | `createReview` | `perfil-publicaciones-resenas-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-092 | DELETE | `/resenas/:id_resena` | usuario | usuario | propietario del recurso | ✅ | `deleteReview` | `perfil-publicaciones-resenas-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-093 | PUT | `/resenas/:id_resena` | usuario | usuario | propietario del recurso | ✅ | `updateReview` | `perfil-publicaciones-resenas-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-094 | GET | `/resenas/usuario/:id_usuario` | público | público | no aplica | ✅ | `getUserReviews` | `perfil-publicaciones-resenas-real.test.ts` |
