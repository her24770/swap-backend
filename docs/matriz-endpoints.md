...
- Rutas con al menos una invocación HTTP localizada: **95/100**
...
| --- | --- | --- | --- | --- | --- |
| EP-001 | GET | `/acuerdo` | autenticado | `getUserAgreements` | `historial-guardados.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-002 | POST | `/acuerdo/:id` | usuario | `createAgreement` | `mensajeria-coordinacion-real.test.ts`, `mensajeria-coordinacion.test.ts`, `moderacion-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
...
| EP-007 | GET | `/acuerdo/conversacion/:id` | autenticado | `getConversationAgreements` | `mensajeria-coordinacion-real.test.ts`, `mensajeria-coordinacion.test.ts`, `autorizacion-endpoints.test.ts` |
...
| EP-014 | POST | `/auth/forgot-password` | público | `forgotPassword` | `auth-sesion.test.ts` |
| EP-015 | POST | `/auth/login` | público | `login` | `auth-sesion.test.ts` |
| EP-016 | POST | `/auth/logout` | público | `logout` | `auth-sesion.test.ts` |
| EP-017 | GET | `/auth/me` | usuario | `getCurrentSession` | `auth-sesion.test.ts`, `moderacion-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-018 | POST | `/auth/register` | público | `register` | `auth-codigos.test.ts` |
| EP-019 | POST | `/auth/reset-password` | público | `resetPassword` | `auth-sesion.test.ts` |
| EP-020 | POST | `/auth/send-register-code` | público | `sendRegisterCode` | `auth-sesion.test.ts` |
| EP-021 | POST | `/auth/verify-reset-code` | público | `verifyResetCode` | `auth-sesion.test.ts` |
| EP-022 | GET | `/busqueda` | autenticado | `semanticSearch` | `autorizacion-endpoints.test.ts` |
| EP-023 | POST | `/certificacion` | usuario | `createCertification` | `moderacion-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
...
| EP-027 | POST | `/conversacion` | usuario | `startConversation` | `mensajeria-coordinacion-real.test.ts`, `mensajeria-coordinacion.test.ts`, `moderacion-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-028 | PATCH | `/conversacion/:id/estado` | usuario | `updateConversationState` | `mensajeria-coordinacion-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-029 | PUT | `/conversacion/:id/estado` | usuario | `updateConversationStateLegacy` | `autorizacion-endpoints.test.ts` |
| EP-030 | GET | `/conversacion/:id/mensajes` | usuario | `getConversationMessages` | `mensajeria-coordinacion-real.test.ts`, `mensajeria-coordinacion.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-031 | GET | `/conversacion/conversaciones` | usuario | `listConversations` | `mensajeria-coordinacion-real.test.ts`, `autorizacion-endpoints.test.ts` |
...
| EP-037 | GET | `/guardados` | usuario | `listSavedPublications` | `historial-guardados.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-038 | DELETE | `/guardados/:publicacionId` | usuario | `removeSavedPublication` | `autorizacion-endpoints.test.ts` |
| EP-039 | POST | `/guardados/:publicacionId` | usuario | `savePublication` | `historial-guardados.test.ts`, `autorizacion-endpoints.test.ts` |
...
| EP-055 | POST | `/moderador/palabras` | moderador | `createRestrictedWord` | `moderacion-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-056 | DELETE | `/moderador/palabras/:id` | moderador | `deleteRestrictedWord` | `moderacion-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
...
| EP-060 | PATCH | `/moderador/publicaciones/:id/bajar` | moderador | `takeDownPublication` | `moderacion-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-061 | PATCH | `/moderador/publicaciones/:id/reactivar` | moderador | `reactivatePublication` | `moderacion-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-062 | GET | `/moderador/usuarios` | moderador | `listUsersForModeration` | `autorizacion-endpoints.test.ts` |
| EP-063 | POST | `/moderador/usuarios/:id/advertencia` | moderador | `warnUser` | `moderacion-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-064 | PATCH | `/moderador/usuarios/:id/estado` | moderador | `updateUserStatus` | `moderacion-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-065 | GET | `/notificacion` | usuario | `listNotifications` | `moderacion-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
...
| EP-086 | POST | `/reportes` | usuario | `createReport` | `moderacion-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
| EP-087 | GET | `/reportes/:id` | moderador | `getReportById` | `moderacion-seguridad-real.test.ts`, `autorizacion-endpoints.test.ts` |
