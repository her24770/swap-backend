...
router.post("/user/:id", autenticar, verificarPropietario, soloUsuario, validar(schemaSincronizarEtiquetas), sincronizarEtiquetasUsuarioController); //Ruta para sincronizar las etiquetas de un usuario
